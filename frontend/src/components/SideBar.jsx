...
function SideBar() {
  ...
  const submitResult = async () => {
    ...
    try{
      ...
      const res = await axios.post(`${API_BASE}/api/result`,payload,{
        headers: {
              ...
              <div className={sidebarStyles.headerDecoration2}>
                ...
                <div className={sidebarStyles.headerContent}>
                  <div className={sidebarStyles.logoContainer}>
                    ...
                    <div>
                      <h1 className={sidebarStyles.logoTitle}>CodeAce</h1>
                      <p className={sidebarStyles.logoSubtitle}>Sharpen your coding skills with concise quizzes across modern technologies.</p>
                    </div>
                  </div>
            ...
            <div className={sidebarStyles.welcomeContainer}>
              <div className={sidebarStyles.welcomeContent}>
                ...
                <p className={sidebarStyles.welcomeDescription}>
                  Choose a topic from the sidebar to start short, focused quizzes at Basic, Intermediate, or Advanced levels.
                </p>
                ...
                <div className={sidebarStyles.featuresGrid}>
                  <div className={sidebarStyles.featureCard}>
                    ...
                    <p className={sidebarStyles.featureDescription}>
                      Covering HTML, CSS, JavaScript, React, Node.js and more.
                    </p>
                  </div>
                  ...
                  <div className={sidebarStyles.featureCard}>
                    ...
                    <p className={sidebarStyles.featureDescription}>
                      Short quizzes at Basic, Intermediate and Advanced skill levels.
                    </p>
                  </div>
                  ...
                  <div className={sidebarStyles.featureCard}>
                    ...
                    <p className={sidebarStyles.featureDescription}>
                      Receive instant scoring and actionable tips to improve.
                    </p>
                  </div>
                </div>
                ...
                <div className={sidebarStyles.welcomePrompt}>
                  <p className={sidebarStyles.welcomePromptText}>
                    ...
                    Pick a topic to start a focused coding quiz — sharpen your skills in minutes.
                  </p>
                </div>
              </div>
            </div>
